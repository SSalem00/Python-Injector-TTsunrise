 ...
 *   gcc -m32 -O2 -shared -o TeamFDInjector.dll TeamFDInjector.c -lkernel32 -luser32 -lgdi32
 * Or with MSVC (x86):
 */
/*
  rebuilt from decompiled TeamFDInjector.dll using https://dogbolt.org/, improved with a console log
 */
